...
const ServiceCategoryCard = ({ title, subtitle, icon, image, badge, onClick }: ServiceCategoryProps) => {
  return (
    <div 
      className="relative bg-card rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer overflow-hidden group"
      onClick={onClick}
    >
...
export const ServiceCategories = ({ onFoodDeliveryClick }: ServiceCategoriesProps) => {
