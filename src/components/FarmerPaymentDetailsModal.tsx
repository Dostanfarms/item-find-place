...
const FarmerPaymentDetailsModal = ({ 
  ...
  const handleSettleSelected = () => {
    ...
    setCurrentSettlement(farmerSummary);
  ...
  const handleConfirmSettlement = async (transactionImage: string) => {
    if (currentSettlement) {
      // Add transaction image to the settlement
      const settlementWithImage = {
        ...currentSettlement,
        settlementReceipt: transactionImage
      };
      await onSettle(settlementWithImage);
      setSelectedProducts([]);
    }
  };
  ...
  return (
    <>
      ...
      <SettlementModal
        ...
        farmerSummary={currentSettlement}
