...
const CustomerHeader: React.FC<CustomerHeaderProps> = ({
  ...
  return <div className="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm border-b p-4">
      <div className="max-w-4xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          {customer ? (/* Profile Dropdown for authenticated users */
        <DropdownMenu>
            ...
            </DropdownMenu>) : (/* Login/Register buttons for non-authenticated users */
