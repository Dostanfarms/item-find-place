...
import { ShoppingCart, User, LogOut, Package, List, ChevronLeft } from 'lucide-react';
  ...
  return <div className="min-h-screen bg-muted/30">
      ...
      <header className="bg-white shadow p-4 sticky top-0 z-10">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="icon" onClick={() => navigate('/customer-home')}>
      ...
      <main className="container mx-auto py-6 px-4">
        <div className="flex justify-between items-center mb-6">
          ...
          <TicketDialog userType="customer" userId={customer.id} userName={customer.name} userContact={customer.mobile || ""} onSubmit={handleTicketSubmit} buttonText="Raise a New Ticket" />
        </div>
        
        {customerTickets.length === 0 ? <Card>
            <CardContent className="flex flex-col items-center justify-center p-6">
              <p className="text-muted-foreground text-center mb-4">You haven't raised any support tickets yet.</p>
              <TicketDialog userType="customer" userId={customer.id} userName={customer.name} userContact={customer.mobile || ""} onSubmit={handleTicketSubmit} buttonText="Raise Your First Ticket" />
            </CardContent>
            ...
            {customerTickets.map(ticket => <Card key={ticket.id}>
                ...
                <CardContent>
                  ...
                  {ticket.resolution && <div className="mt-4 border-t pt-4">
