  ...
  return <div className="min-h-screen bg-muted/30 p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <Card className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => navigate('/customer-order-history')}>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
          ...
          <Card className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => navigate('/customer-profile')}>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <User className="h-5 w-5" />
                Profile
