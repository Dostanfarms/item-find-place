...
// Updated branch access logic for multiple branches
export const canAccessBranch = (userRole: string, userBranchIds: string[] | null | undefined, targetBranchId: string | null): boolean => {
  ...
  // If user has no branches assigned, they can only access items with no branch
  ...
  return userBranchIds.includes(targetBranchId!) || targetBranchId === null;
};
...
export const canCreateInBranch = (userRole: string, userBranchIds: string[] | null | undefined, targetBranchId: string | null): boolean => {
  return canAccessBranch(userRole, userBranchIds, targetBranchId);
};

export const canEditInBranch = (userRole: string, userBranchIds: string[] | null | undefined, targetBranchId: string | null): boolean => {
  return canAccessBranch(userRole, userBranchIds, targetBranchId);
};
