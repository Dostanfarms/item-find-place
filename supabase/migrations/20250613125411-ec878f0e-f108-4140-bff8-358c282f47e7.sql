...
INSERT INTO public.roles (name, description, permissions, is_active) VALUES
('admin', 'Administrator with full access', '[{"resource": "products", "actions": ["create", "read", "update", "delete"]}, {"resource": "users", "actions": ["create", "read", "update", "delete"]}, {"resource": "orders", "actions": ["create", "read", "update", "delete"]}]', true),
('sales', 'Sales representative', '[{"resource": "products", "actions": ["read"]}, {"resource": "orders", "actions": ["create", "read", "update"]}]', true),
('manager', 'Manager role', '[{"resource": "products", "actions": ["create", "read", "update"]}, {"resource": "orders", "actions": ["read", "update"]}]', true);
